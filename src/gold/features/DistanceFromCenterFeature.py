    ...
    def calculate_feature(self):
        ...
        if black_move == []:
            if white_move == []:
                ...
                return ((((white_move[0] - originalCenter[0]) ** 2) + ((white_move[1] - originalCenter[1]) ** 2)) ** .5) / furthest
        else:'''
        return ((((black_move[0] - originalCenter[0]) ** 2) + ((black_move[1] - originalCenter[1]) ** 2)) ** .5) / furthest
